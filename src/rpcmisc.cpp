...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("difficulty_neoscrypt",  (double)GetDifficulty(NULL, ALGO_NEOSCRYPT)));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"PONDaddress\"\n"
            "\nReturn information about the given POND address.\n"
            "\nArguments:\n"
            "1. \"PONDaddress\"     (string, required) The POND address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,            (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"PONDaddress\", (string) The POND address validated\n"
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are POND addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) POND address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"PONDaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"PONDaddress\"  (string, required) The POND address to use for the signature.\n"
