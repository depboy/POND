...
public:
    CMainParams() {
		...
		bnProofOfWorkLimit[ALGO_NEOSCRYPT]   = CBigNum(~uint256(0) >> 20);
        ...
        vSeeds.push_back(CDNSSeedData("seed1.POND.org", "seed1.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed2.POND.org", "seed2.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed3.POND.org", "seed3.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed4.POND.org", "seed4.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed5.POND.org", "seed5.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed6.POND.org", "seed6.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed7.POND.org", "seed7.POND.org"));
        vSeeds.push_back(CDNSSeedData("seed8.POND.org", "seed8.POND.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseed1.POND.org", "testseed1.POND.org"));
...
public:
    CRegTestParams() {
		...
		bnProofOfWorkLimit[ALGO_NEOSCRYPT]   = CBigNum(~uint256(0) >> 1);
		bnProofOfWorkLimit[ALGO_LYRA2RE]   = CBigNum(~uint256(0) >> 1);
