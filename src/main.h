...
const int64_t nBlockAlgoNormalisedWorkDecayStart = 0; // block where weight decay starts
...
const int nBlockSequentialAlgoMaxCount = 0; // maximum sequential blocks of same algo
const int nBlockSequentialAlgoMaxCount2 = 0; // maximum sequential blocks of same algo
const int64_t nBlockTimeWarpPreventStart = 0; // block where time warp 1 prevention starts
const int64_t nBlockTimeWarpPreventStart2 = 0; // block where time warp 2 prevention starts
const int64_t nBlockDiffAdjustV2 = 0; // block where difficulty adjust V2 starts
